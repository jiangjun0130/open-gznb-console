...
public class IntrospectorUtils {
     ...
     * false：不为空
     */
    public static Boolean entityIsNull(Object object) throws IntrospectionException, InvocationTargetException, IllegalAccessException {
        if (object == null) {
            return true;
        }
